<?php $__env->startSection('title', 'سارة - منصة ذكاء اصطناعي لخدمة العملاء'); ?>
...
<?php $__env->startSection('content'); ?>
                ...
                <div class="text-center lg:text-end">
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(auth()->user()->role === 'admin' ? route('admin.dashboard') : route('customer.dashboard')); ?>" class="w-full sm:w-auto px-8 py-4 bg-[#00A8E8] text-white rounded-xl font-bold text-lg shadow-xl shadow-[#00A8E8]/20 hover:bg-[#007EA7] transition-all hover:-translate-y-1 text-center">
                                دخول إلى المنصة
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('register')); ?>" class="w-full sm:w-auto px-8 py-4 bg-[#00A8E8] text-white rounded-xl font-bold text-lg shadow-xl shadow-[#00A8E8]/20 hover:bg-[#007EA7] transition-all hover:-translate-y-1 text-center">
                                جرب المنصة مجاناً
                            </a>
                        <?php endif; ?>
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                <div class="bg-gray-800/50 backdrop-blur rounded-3xl border border-gray-700/50 p-8 hover:border-[#00A8E8]/30 transition-all">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="block w-full py-3 text-center border border-[#00A8E8] text-[#00A8E8] rounded-xl font-bold hover:bg-[#00A8E8] hover:text-white transition-all">ابدأ الآن</a>
                </div>
                ...
                <div class="relative bg-gradient-to-b from-[#00A8E8]/10 to-gray-800/50 backdrop-blur rounded-3xl border border-[#00A8E8]/30 p-8 scale-105">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="block w-full py-3 text-center bg-[#00A8E8] text-white rounded-xl font-bold hover:bg-[#007EA7] transition-all shadow-lg shadow-[#00A8E8]/30">ابدأ الآن</a>
                </div>
    ...
    <section class="py-20 bg-gradient-to-r from-[#00A8E8] to-[#00658B] text-white">
        <div class="container mx-auto px-6 text-center">
            ...
            <a href="<?php echo e(route('register')); ?>" class="inline-block px-10 py-4 bg-white text-[#00A8E8] rounded-xl font-bold text-lg hover:bg-gray-100 transition-all shadow-xl hover:-translate-y-1">
                سجل مجاناً الآن
            </a>
        </div>
    </section>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ENG.THURAYA\Documents\sarav3\resources\views/pages/home.blade.php ENDPATH**/ ?>